...
function my_enqueue_scripts_frontpage() {
	wp_enqueue_style( 'default', get_template_directory_uri() . '/style.min.css', array(), '3.0' );
	...
	wp_enqueue_script( 'base', get_template_directory_uri() . '/js/global.min.js', array(), '3.0', true);
